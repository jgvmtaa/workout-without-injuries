...
/**
 * Three-category classification for the exercise library and plan generation (spec §9).
 *
...
/**
 * Result of categorizing the whole catalog against one profile (spec §9).
 *
 ...
 * because the safety signal is what must be surfaced (spec §2, §9).
 */
