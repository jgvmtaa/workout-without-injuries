...
/**
 * One exercise in the static catalog (spec §5.3).
 *
 ...
 * confirmed one of them (spec §8). Getting it wrong in either direction is a real
 ...
 *   exercise `Unavailable`, not `Excluded` (spec §9).
 */
