...
/**
 * One injury the user reported, with the detail they chose to give (spec §4.4).
 *
...
/** Which side of the body an injury affects (spec §4.4). */
enum class BodySide {
    LEFT,
    RIGHT,
    BOTH,
...
/**
 * How current an injury is (spec §4.4).
 *
