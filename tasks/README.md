...
¹ Builds green and both test suites pass, including the instrumented ones. One
completion criterion — profile survives closing and reopening the app — has only been
proven by tests, not by hand on a device. See
